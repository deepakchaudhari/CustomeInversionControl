...
public class Container {
    ...
    public <T> T resolve(Class<T> type) throws IoCException {
        ...
        List<com.ioc.Constructor> constructorParams = registration.getConstructorParams();
        T instance;
        try {
    ...
    private void getNonReferenceParameters(List<com.ioc.Constructor> constructorParams, List<Object> parameterInstances, Parameter parameter, Class parameterClass) {
        Object value = null;
        for (com.ioc.Constructor ctor : constructorParams) {
